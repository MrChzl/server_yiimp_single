...
php-pear php-auth-sasl mcrypt imagemagick libruby \
php7.3-curl php7.3-intl php7.3-pspell php7.3-recode php7.3-sqlite3 \
php7.3-tidy php7.3-xmlrpc php7.3-xsl php7.3-memcache memcached php7.3-memcached \
...
cd $STORAGE_ROOT/yiimp/yiimp_setup/yiimp
hide_output sudo git clone https://github.com/MrChzl/stratum-lowdiff.git
sleep 2s

echo -e " Downloading Full Stratum...$COL_RESET"
cd $STORAGE_ROOT/yiimp/yiimp_setup/yiimp
hide_output sudo git clone https://github.com/MrChzl/stratum-full.git
sleep 2s

echo -e " Downloading Zentoshi Stratum...$COL_RESET"
cd $STORAGE_ROOT/yiimp/yiimp_setup/yiimp
hide_output sudo git clone https://github.com/MrChzl/stratum-zenx.git
sleep 2s
